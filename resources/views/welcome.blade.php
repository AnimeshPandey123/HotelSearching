                        ...
                        <nav class="navbar navbar-expand-lg narbar-light">
                            ...
                            <div id="mainNav" class="collapse navbar-collapse tm-bg-white">
                                <ul class="navbar-nav ml-auto ">
                                  <li class="nav-item">
                                    <a class="nav-link" id="home" href="{{route('navigation.home')}}">Home <span class="sr-only">(current)</span></a>
                                  </li>
                                  <li class="nav-item">
                                    <a class="nav-link" id="nav2" href="{{route('navigation.sec2')}}">Portfolio</a>
                                  </li>
                                  <li class="nav-item">
                                ...
                                <form action="{{route('hotels.search')}}" method="post" class="tm-search-form tm-section-pad-2">
                                    ...
                                    <div class="form-row tm-search-form-row">
                                        <div class="form-group tm-form-element tm-form-element-100">
                                            ...
                                            <input name="hotels" type="text" class="form-control" placeholder="Type your destination...">
                                        </div>
